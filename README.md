...
<table width="100%">
  <thead>
    <tr>
      <th width="120" align="left" nowrap>平台</th>
      <th width="140" align="center" nowrap>状态</th>
      <th width="195" align="center" nowrap>最高画质支持</th>
      <th width="368" align="left" nowrap>说明</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
- 📺 **频道热重载管理**：在网页端直接**添加、编辑、删除**频道，或者**一键开关、一键重启推流**；支持拖动直播卡片调整频道顺序并自动持久化，改动**实时热生效，无需重启服务**；
